...
if(WIN32)
    if(${CMAKE_SIZEOF_VOID_P} EQUAL 8)
        find_file(BLAS_LIBRARIES libopenblas.lib HINTS ${BLAS_DIR}/lib)
...
find_path(BLAS_INCLUDE_DIRS cblas.h HINTS ${BLAS_DIR}/include ${BLAS_DIR}/include/openblas64 ${BLAS_DIR}/include/x86_64-linux-gnu ${BLAS_DIR}/include/x86_64/linux-gnu)
find_path(LAPACKE_INCLUDE_DIRS lapacke.h HINTS ${BLAS_DIR}/include ${BLAS_DIR}/include/openblas64)
